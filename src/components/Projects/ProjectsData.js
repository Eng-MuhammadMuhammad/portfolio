...
import ExpenseTrack from "../../imgs/ExpenseTrack.png";
import TaskManagment from "../../imgs/TaskManagment.png";

const ProjectsData = [
  {
    id: 1,
    label: "Employee-Task-Management-Platform",
    image: TaskManagment,
    link: "https://emplyee-task-managment-platform.vercel.app/",
    description:
      "A platform for managing employee tasks, enabling assignment, tracking, and collaboration on workplace responsibilities.",
  },
  {
    id: 2,
    label: "ExpenseTrack",
    ...
    description:
      "A sleek and intuitive expense tracking app for managing personal finances.",
  },
  {
    id: 3,
